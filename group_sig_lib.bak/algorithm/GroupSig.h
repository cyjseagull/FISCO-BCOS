 ...
 */
int create_group_default(std::string& result, const std::string& algorithm_method);
 ...
 */
int create_group(
    std::string& result, const std::string& algorithm_method, const std::string& pbc_param_str);
 ...
 *       (failed reasons maybe input param can't be parsed...)
 */
int group_member_join(std::string& gsk, const std::string& algorithm_method,
    const std::string& pbc_param_info, const std::string& gmsk_info, const std::string& gpk_info,
 ...
 *       (failed reasons maybe input param can't be parsed...)
 */
int group_sig(std::string& result, const std::string& algorithm_method, const std::string& gpk_info,
    const std::string& gsk_info, const std::string& pbc_param_info, const std::string& message);
 ...
 *       (failed reasons maybe input param can't be parsed...)
 */
int group_verify(int& ret, const std::string& message, const std::string& sig,
    const std::string& algorithm_method, const std::string& gpk_info,
 ...
 *       (failed reasons maybe input param can't be parsed...)
 */
int open_cert(std::string& cert, const std::string& algorithm_method, const std::string& sig,
    const std::string& message, const std::string& gpk_info, const std::string& gmsk_info,
    const std::string& pbc_param_info);
 ...
 *       (failed reasons maybe input param can't be parsed...)
 */
int revoke_member(std::string& gpk, const std::string& algorithm_method,
    const std::string& pbc_param, const std::string& revoke_info, const std::string& gamma_info);
 ...
 *       (failed reasons maybe input param can't be parsed...)
 */
int revoke_update_private_key(std::string& gsk, const std::string& algorithm_method,
    const std::string& pbc_param, const std::string& revoke_list, const std::string& gone_list,
