...
public:
    ...
    void setHostNodeInfo(P2PInfo const& _hostNodeInfo) { m_hostNodeInfo = _hostNodeInfo; }
...
{
public:
    SessionFactory(P2PInfo _hostNodeInfo, uint32_t _sessionRecvBufferSize,  // NOLINT
      ...
      : m_hostNodeInfo(std::move(_hostNodeInfo)),
        ...
        SessionCallbackManagerInterface::Ptr& _sessionCallbackManager)
    {
        ...
        session->setHostNodeInfo(m_hostNodeInfo);
