...
int create_group(
    std::string& result, const std::string& algorithm_method, const std::string& pbc_param_info)
{
...
int group_sig(std::string& sig, const std::string& algorithm_method, const std::string& gpk_info,
...
int group_verify(int& valid, const std::string& sig, const std::string& message,
